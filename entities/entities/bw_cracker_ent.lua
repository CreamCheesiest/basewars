...
if SERVER then
	...
	function ENT:FindTargets()
		...
		for i, v in pairs(ents.FindInSphere(p_pos, maxRange)) do
			if (v.Base == "bw_base_electronics" or v.Base == "bw_base_moneyprinter" or v:GetClass() == "bw_base_jammer" or v.Base == "bw_base_turret") and BaseWars.PrinterCheck(v:CPPIGetOwner()) then

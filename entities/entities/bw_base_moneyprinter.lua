...
if SERVER then
	...
	if CLIENT then
		function ENT:DrawDisplay(pos, ang, scale)
			...
			draw.DrawText(" / ", font, w / 2 - StrW / 2, font == fontName .. ".Big" and 106 or 105 + fh / 4, self.FontColor, TEXT_ALIGN_LEFT)
			local moneyW, moneyH = surface.GetTextSize(currentMoney)
			draw.DrawText(currentMoney, font, w / 2 - StrW / 2 - moneyW, font == fontName .. ".Big" and 106 or 105 + fh / 4, self.FontColor, TEXT_ALIGN_LEFT)
			draw.DrawText(maxMoney, font, w / 2 + StrW / 2, font == fontName .. ".Big" and 106 or 105 + fh / 4, self.FontColor, TEXT_ALIGN_Right)
			--Paper

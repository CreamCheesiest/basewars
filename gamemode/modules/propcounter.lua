...
l_hAd("HUDPaint", "ClientPropCounterHUDHook", function()
  ...
  l_dSTt( l_LP():GetCount( "props" ) .. " / 50" or 0, "PropCounterText", AdjustHUDPos["propCTLX"], AdjustHUDPos["propCTLY"],l_Cr(mainHUDTextColor["r"], mainHUDTextColor["g"], mainHUDTextColor["b"], rgba_alpha_text ), 1, 1,TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)

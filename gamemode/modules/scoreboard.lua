...
----------LAUNCH SEQUENCE----------
	local CreateScoreboard = function()
        ...
        local 	Columns = {}
                ...
                Columns[2] = {name="Rank", command=function(self, arg) return arg:GetUserGroup()  end}
                Columns[3] = {name="Faction", command=function(self, arg) return team.GetName( arg:Team() )  end}
                Columns[4] = {name="Level", command=function(self, arg) return arg:GetLevel()  end}

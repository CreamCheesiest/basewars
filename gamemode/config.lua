...
BaseWars.Config = {
	...
	SpawnWeps = {"weapon_physcannon", "hands",},
	WeaponDropBlacklist = {
		["weapon_physgun"] = true,
...
BaseWars.NPCTable = {} --[[["basewars_bangclaw_v1"] = {
...
BaseWars.Config.RulesTbl = {"1. Do not base with someone unless you are in a faction with them.", "2. Do not propblock OTHER peoples bases (You CAN block your own).", "3. Do not attempt to circumvent Anti-RandomRaid or similar systems.", "4. You must base in A SINGLE CONTINOUS SPACE. NO multi-basing!",}

BaseWars.Config.Help = {
	["What is this server?"] = {"This is the Hexahedronic BaseWars server.", "It runs a custom version of basewars!", "", "BaseWars is a gamemode about making money and raiding.", "It also contains cool guns and ways to defend your base!",},
	["What are the controls?"] = {"To spawn printers and other entities you can open the spawnmenu by holding [Q] or your binding for it,", "From here you can select the [Entities] sub-category of the [BaseWars] tab. (NOT THE ENTITIES TAB!)", "", "To Raid or Create a Faction you can press [F3] to open the [Main Menu]. From here you can select [Factions],", "[Raids], [Rules] and in the future the [Store] and your [Equipment Inventory]!",},
	["How do I make a base?"] = {"Firstly find an area in the map which is secure, and you would be happy defending,", "Then use some props from spawnmenu sub-categories to secure the entrances,", "Finally use the [Fading Door] tool to make yourself a secure way in and out.", "", "After you have secured the area, you can buy Printers and Generators from the [BaseWars] tab."},
	["How do I raid?"] = {"To raid you and your TARGET must both have GOLD or HIGHER printer-types.", "", "If you are raidable, press F3, then select the [Raids] tab, followed by clicking on your TARGET's name.", "Watch the [Notifications] in the top left to see if they are raidable, if they were, then a raid will", "have started, if not, it will tell you why not.", "", "Once a raid has started you can destroy any props your enemy owns, along with electronics! But be careful!", "They can counter raid you while it is on-going!",},
	["Are there any rules?"] = {"Yes, press F3 then select the [Rules] tab!",},
	["Do items require power?"] = {"Items do not require electricity to run. Originally, this gamemode did provide generators.", "However, we turned it off as it seemed more of a hassle, and took away freedom on the size of bases."},
	["What about RDM (Killing people randomly)?"] = {"RDM is ALLOWED. Do not complain and instead if you so desire seek your own revenge.", "In the future the [Karma] system will punish mass RDMers with longer respawns and other debuffs.",},
	["How do I upgrade my printers?"] = {"All you need to do is look at them and type /upg", "You can bind \"basewars upgrade\" to a key to do it automaticly!",},
	["How do I sell my printers?"] = {"All you need to do is look at them and type /sell", "You can bind \"basewars sell\" to a key to do it automaticly!",},
	["How do I level up?"] = {"To level up you have to do different things like", "buy printers, raid and collect from money from printers."},
	["What does a higher level earn me?"] = {"When you level up, you unlock new items.", "They are usually more powerful or more efficient than the older version."},
	["What is the 'E Use/Collect Money' thingy?"] = {"It shows you what can you do with that entity.", "If you don't like it, you can disable it by typing", "'interactions_enabled 0' into your console.",},
	["How do I access my weapons that I've picked up?"] = {"To access your inventory, press F3 and go to the inventory tab.", "From there, you left click to equip, right click to drop.", "If you want to move an item from your hands to your inventory, type /inv", "And yes, your inventory is saved across server restarts and disconnects!"}
}

BaseWars.Config.DrugHelp = {
	["What does the Regen drug do?"] = {"Regen does exactly what it says on the tin!", "You will regenerate HP (and armor) for 30 seconds.",},
	["What does the Steroid drug do?"] = {"Steroid increases your move speed!", "You will move 2x faster for 2 minutes.",},
	["What does the Adrenaline drug do?"] = {"Adrenaline increases your maximum health!", "Your max health will be increased by 50% for 2 minutes.",},
	["What does the DoubleJump drug do?"] = {"Do you really need a explanation for that?", "You can jump once more in air.",},
	["What does the PainKiller drug do?"] = {"Painkillers will help your survive longer in a fight.", "You will experience 30% less damage.",},
	["What does the Shield drug do?"] = {"Shield will help you when you need it the most.", "You will be survive one killing blow.",},
	["What does the Rage drug do?"] = {"Rage will help you fight other players!", "You will deal 20% more damage for 2 minutes",},
}

BaseWars.Config.CommandsHelp = {
	["Upgrade Items"] = {"Everyone loves a little efficiency.", "Look at your printer and use one of these.", "", "/upg        /upgrade        /upgr", "", "Or use the BaseWars Upgrade tool in the Q menu."},
	["Sell Items"] = {"Didn't mean to buy that? Want to get rid of it? Need some your money back?.", "Look at your item and use one of these.", "", "/sell        /destroy        /remove", "", "Or use the BaseWars Sell tool in the Q menu.", "", "You can also use:", "/sellall", "To sell all your entities!"},
	["Drop Weapons"] = {"Sometimes the noobs need a little extra defense.", "", "/dw        /dropweapon        /dropwep",},
		--[[["Private Message"] = {
    "Psst...",
    "",
...
BaseWars.SpawnList.Models.Loadout["Melee Weapons - T1"] = {
	...
	["CT Knife"] = BaseWars.GSL{
		Gun = true,
		Model = "models/weapons/w_knife_ct.mdl",
		Price = 10000,
		ClassName = "arc9_go_knife_ct",
		Level = 3
	},
	["T Knife"] = BaseWars.GSL{
		Gun = true,
		Model = "models/weapons/w_knife_t.mdl",
		Price = 10000,
		ClassName = "arc9_go_knife_t",
		Level = 3
	}
}

BaseWars.SpawnList.Models.Loadout["Pistols - T1"] = {
	["Beretta"] = BaseWars.GSL{
		Gun = true,
	...
	["Five Seven"] = BaseWars.GSL{
		...
		Price = 25000,
		ClassName = "arc9_go_fiveseven",
		Level = 12
	},
	["Glock-18"] = BaseWars.GSL{
		Gun = true,
		Model = "models/weapons/w_pist_glock18.mdl",
		Price = 22500,
		ClassName = "arc9_go_glock",
		Level = 10
	},
	["P2000"] = BaseWars.GSL{
		Gun = true,
	...
	["USP-S"] = BaseWars.GSL{
		...
		Model = "models/weapons/w_pist_usp.mdl",
		Price = 27500,
		ClassName = "arc9_go_usp",
		Level = 15
	},
	["R8 Revolver"] = BaseWars.GSL{
		Gun = true,
		Model = "models/weapons/w_pist_deagle.mdl",
		Price = 35000,
		ClassName = "arc9_go_r8",
		Level = 15
	},
	["CZ-75"] = BaseWars.GSL{
		Gun = true,
	...
	["Deagle"] = BaseWars.GSL{
		...
		Model = "models/weapons/w_pist_deagle.mdl",
		Price = 50000,
		ClassName = "arc9_go_deagle",
		Level = 20
	},
}

BaseWars.SpawnList.Models.Loadout["Pistols - T2"] = {
	["Dual Beretta"] = BaseWars.GSL{
		Gun = true,
		Model = "models/weapons/w_pist_elite.mdl",
		Price = 50000,
		ClassName = "arc9_go_elite",
		Level = 25
	},
	["Dual Five Seven"] = BaseWars.GSL{
		Gun = true,
		Model = "models/weapons/csgo/c_akimbo_usp.mdl",
		Price = 60000,
		ClassName = "arc9_go_akimbo_fiveseven",
		Level = 27
	},
	["Dual Glock-18"] = BaseWars.GSL{
		Gun = true,
		Model = "models/weapons/csgo/c_akimbo_usp.mdl",
		Price = 55000,
		ClassName = "arc9_go_akimbo_glock",
		Level = 25
	},
	["Dual P2000"] = BaseWars.GSL{
		Gun = true,
		Model = "models/weapons/w_pist_elite.mdl",
		Price = 50000,
		ClassName = "arc9_go_akimbo_p2000",
		Level = 25
	},
	["Dual P250"] = BaseWars.GSL{
		Gun = true,
		Model = "models/weapons/csgo/c_akimbo_usp.mdl",
		Price = 70000,
		ClassName = "arc9_go_akimbo_p250",
		Level = 30
	},
	["Dual USP"] = BaseWars.GSL{
		Gun = true,
		Model = "models/weapons/csgo/c_akimbo_usp.mdl",
		Price = 65000,
		ClassName = "arc9_go_akimbo_usp",
		Level = 30
	},
	["Dual R8 Revolver"] = BaseWars.GSL{
		Gun = true,
		Model = "models/weapons/csgo/c_akimbo_usp.mdl",
		Price = 80000,
		ClassName = "arc9_go_akimbo_r8",
		Level = 30
	},
	...
	["Dual Deagle"] = BaseWars.GSL{
		Gun = true,
		Model = "models/weapons/w_pist_elite.mdl",
		Price = 110000,
		ClassName = "arc9_go_akimbo_deagle",
		Level = 30
	}
}
...
BaseWars.SpawnList.Models.Loadout["Utility - T1"] = {
	...
	["Radar"] = BaseWars.GSL{
		Gun = true,
		Model = "models/weapons/w_motion_tracker.mdl",
		Price = 100000,
		ClassName = "weapon_radar",
		Level = 15
	},
	["C4"] = BaseWars.GSL{
		Gun = true,
...
BaseWars.SpawnList.Models.Entities["Structures (T1)"] = {
	-- T1
	["Spawnpoint"] = BaseWars.GSL{
		Model = "models/props_trainstation/trainstation_clock001.mdl",
		Price = 15000,
		ClassName = "bw_spawnpoint",
		UseSpawnFunc = true,
		Level = 30
	},
	["Drug Lab"] = BaseWars.GSL{
		Model = "models/props_lab/crematorcase.mdl",
		Price = 35000,
		ClassName = "bw_druglab",
		Level = 30
	},
...
BaseWars.SpawnList.Models.Entities["Consumables (T1)"] = {
	["Repair Kit"] = BaseWars.GSL{
		Model = "models/Items/car_battery01.mdl",
		Price = 2500,
		ClassName = "bw_repairkit",
		UseSpawnFunc = true
	},
	["Armour Kit"] = BaseWars.GSL{
	...
	["Printer Paper"] = BaseWars.GSL{
		Model = "models/props_junk/garbage_newspaper001a.mdl",
		Price = 2000,
		ClassName = "bw_printerpaper",
		UseSpawnFunc = true
	},
}
...
BaseWars.SpawnList.Models.Entities["Printers (T1)"] = {
	-- T1
	["Basic Printer"] = BaseWars.GSL{
		Model = "models/props_lab/reciever01a.mdl",
		Price = 5000,
		ClassName = "bw_base_moneyprinter"
	},
	["Copper Printer"] = BaseWars.GSL{
		Model = "models/props_lab/reciever01a.mdl",
		Price = 18000,
		ClassName = "bw_printer_copper",
		Level = 10
	},
	["Silver Printer"] = BaseWars.GSL{
		Model = "models/props_lab/reciever01a.mdl",
		Price = 24000,
		ClassName = "bw_printer_silver",
		Level = 20
	},
	["Gold Printer"] = BaseWars.GSL{
		Model = "models/props_lab/reciever01a.mdl",
		Price = 30000,
		ClassName = "bw_printer_gold",
		Level = 30
	},
	["Platinum Printer"] = BaseWars.GSL{
		Model = "models/props_lab/reciever01a.mdl",
		Price = 36000,
...
BaseWars.SpawnList.Models.Fun["Synthesizer"] = {
	["Synthesizer"] = BaseWars.GSL{
		Model = "models/tnf/synth.mdl",
		Price = 25000,
		ClassName = "synthesizer",
		Level = 10
	},
	["Synthesizer Accordion"] = BaseWars.GSL{
		Model = "models/tnf/synth.mdl",
		Price = 25000,
		ClassName = "synthesizer_accordion",
		Level = 11
	},
	["Synthesizer Electric Guitar"] = BaseWars.GSL{
		Model = "models/tnf/synth.mdl",
		Price = 25000,
		ClassName = "synthesizer_electric_guitar",
		Level = 12
	},
	["Synthesizer Guitar"] = BaseWars.GSL{
		Model = "models/tnf/synth.mdl",
		Price = 25000,
		ClassName = "synthesizer_guitar",
		Level = 13
	},
	["Synthesizer Harp"] = BaseWars.GSL{
		Model = "models/tnf/synth.mdl",
		Price = 25000,
		ClassName = "synthesizer_harp",
		Level = 14
	},
	["Synthesizer Organ"] = BaseWars.GSL{
		Model = "models/tnf/synth.mdl",
		Price = 25000,
		ClassName = "synthesizer_organ",
		Level = 15
	},
	["Synthesizer Piano"] = BaseWars.GSL{
		Model = "models/tnf/synth.mdl",
		Price = 25000,
		ClassName = "synthesizer_piano",
		Level = 16
	},
	["Synthesizer Saxophone"] = BaseWars.GSL{
		Model = "models/tnf/synth.mdl",
		Price = 25000,
		ClassName = "synthesizer_sax",
		Level = 17
	},
	["Synthesizer Violin"] = BaseWars.GSL{
		Model = "models/tnf/synth.mdl",
		Price = 25000,
		ClassName = "synthesizer_violin",
		Level = 18
	},
}
